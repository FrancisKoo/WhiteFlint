...
void D3D12HelloWindow::LoadPipeline()
{
    ...
    // Create descriptor heaps.
    {
        ...
        // Describe and create a shader resouce view (SRV) heap for the texture.
...
void D3D12HelloWindow::LoadAssets()
{
    // Create the root signature.
    {
        ...
        // This is the highest version the sample supprots. If CheckFeatureSupport succeeds, the HighestVersion returned will not be greater than this.
    ...
    com_ptr<ID3D12Resource> textureUploadHeap;
